...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['placa'], $_POST['fecha'])) 
        ...
        try {
            ...
            $condicion = "placas = '$placa' AND fecha = '$fecha' "; // consulta SQL

            // Llamar al método para validar el ingreso
            if ($conexion->validarIngreso($placa, $fecha, 'Superviciones', $condicion, 'RegistrarSupervisiones.php')) { // 'Registrar visiones' es la tabla
